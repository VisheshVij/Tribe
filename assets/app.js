...
import { LayoutDashboard, Compass, ShieldCheck, Users, User, X, Check, Github, Trophy, Clock, ChevronRight, ChevronLeft, Sparkles, TriangleAlert as AlertTriangle, ArrowRight, Zap, MapPin, ExternalLink, FolderGit2, Send, Award, Circle, Plus, LogOut, Eye, EyeOff, Lock, Mail, Briefcase, FileCheck2, Link2, GitBranch, Target, CircleCheck as CheckCircle2, CircleX as XCircle, LoaderCircle as Loader2, BadgeCheck, TrendingUp, Filter, Bell, ClipboardList, Rocket, Swords, UserPlus, ArrowLeft, Info, RotateCcw, Camera, Upload, Trash2, UserMinus, Mic, Volume2, Maximize2, Minimize2, Image as ImageIcon } from "lucide-react";
...
function SkillRadar({
  ...
  })), hovered !== null && data[hovered] && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 10,
